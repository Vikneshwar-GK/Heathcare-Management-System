 ...
 * @author Vignesh
 */
public class Admin_Account_Del extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Account_Del
     */
    public Admin_Account_Del() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACCOUNT  -  DELETE");
        ...
        jButton1.setActionCommand("FIND");
...
/**/
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(id.equals("")){
            ...
            try{
                ...
                String query="delete from cust where user_id='"+id+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Account_Del.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Account_Del().setVisible(true);
            }
        });
    }
